// $ANTLR 3.3 Nov 30, 2010 12:50:56 C:\\Users\\Timo\\EclipseProjects\\GalaxyX\\build\\classes\\com\\galaxyx\\galaxyxparser\\GalaxyXHeaderWalker.g 2013-03-02 17:19:10
...
public class GalaxyXHeaderWalker extends TreeParser {
    ...
    public String getGrammarFileName() { return "C:\\Users\\Timo\\EclipseProjects\\GalaxyX\\build\\classes\\com\\galaxyx\\galaxyxparser\\GalaxyXHeaderWalker.g"; }



    // $ANTLR start "rule"
    // C:\\Users\\Timo\\EclipseProjects\\GalaxyX\\build\\classes\\com\\galaxyx\\galaxyxparser\\GalaxyXHeaderWalker.g:12:1: rule : ( define )* EOF ;
    public final void rule() throws RecognitionException {
        try {
            // C:\\Users\\Timo\\EclipseProjects\\GalaxyX\\build\\classes\\com\\galaxyx\\galaxyxparser\\GalaxyXHeaderWalker.g:12:5: ( ( define )* EOF )
            // C:\\Users\\Timo\\EclipseProjects\\GalaxyX\\build\\classes\\com\\galaxyx\\galaxyxparser\\GalaxyXHeaderWalker.g:12:7: ( define )* EOF
            {
            // C:\\Users\\Timo\\EclipseProjects\\GalaxyX\\build\\classes\\com\\galaxyx\\galaxyxparser\\GalaxyXHeaderWalker.g:12:7: ( define )*
            loop1:
            do {
                int alt1=2;
    ...
    // $ANTLR start "define"
    // C:\\Users\\Timo\\EclipseProjects\\GalaxyX\\build\\classes\\com\\galaxyx\\galaxyxparser\\GalaxyXHeaderWalker.g:14:1: define : ^( DEFINE i1= IDENTIFIER i2= basic ) ;
    public final void define() throws RecognitionException {
        ...
        try {
            // C:\\Users\\Timo\\EclipseProjects\\GalaxyX\\build\\classes\\com\\galaxyx\\galaxyxparser\\GalaxyXHeaderWalker.g:15:2: ( ^( DEFINE i1= IDENTIFIER i2= basic ) )
            // C:\\Users\\Timo\\EclipseProjects\\GalaxyX\\build\\classes\\com\\galaxyx\\galaxyxparser\\GalaxyXHeaderWalker.g:15:4: ^( DEFINE i1= IDENTIFIER i2= basic )
            {
    ...
    // $ANTLR start "basic"
    // C:\\Users\\Timo\\EclipseProjects\\GalaxyX\\build\\classes\\com\\galaxyx\\galaxyxparser\\GalaxyXHeaderWalker.g:18:1: basic returns [String s] : (i1= IDENTIFIER | i1= INTEGER | i1= FIXED_LITERAL | i1= CHARACTER_LITERAL | i1= STRING_LITERAL ) ;
    public final String basic() throws RecognitionException {
        ...
        try {
            // C:\\Users\\Timo\\EclipseProjects\\GalaxyX\\build\\classes\\com\\galaxyx\\galaxyxparser\\GalaxyXHeaderWalker.g:19:2: ( (i1= IDENTIFIER | i1= INTEGER | i1= FIXED_LITERAL | i1= CHARACTER_LITERAL | i1= STRING_LITERAL ) )
            // C:\\Users\\Timo\\EclipseProjects\\GalaxyX\\build\\classes\\com\\galaxyx\\galaxyxparser\\GalaxyXHeaderWalker.g:19:4: (i1= IDENTIFIER | i1= INTEGER | i1= FIXED_LITERAL | i1= CHARACTER_LITERAL | i1= STRING_LITERAL )
            {
            // C:\\Users\\Timo\\EclipseProjects\\GalaxyX\\build\\classes\\com\\galaxyx\\galaxyxparser\\GalaxyXHeaderWalker.g:19:4: (i1= IDENTIFIER | i1= INTEGER | i1= FIXED_LITERAL | i1= CHARACTER_LITERAL | i1= STRING_LITERAL )
            int alt2=5;
            switch ( input.LA(1) ) {
            ...
            switch (alt2) {
                case 1 :
                    // C:\\Users\\Timo\\EclipseProjects\\GalaxyX\\build\\classes\\com\\galaxyx\\galaxyxparser\\GalaxyXHeaderWalker.g:19:5: i1= IDENTIFIER
                    {
                    ...
                    break;
                case 2 :
                    // C:\\Users\\Timo\\EclipseProjects\\GalaxyX\\build\\classes\\com\\galaxyx\\galaxyxparser\\GalaxyXHeaderWalker.g:20:4: i1= INTEGER
                    {
                    ...
                    break;
                case 3 :
                    // C:\\Users\\Timo\\EclipseProjects\\GalaxyX\\build\\classes\\com\\galaxyx\\galaxyxparser\\GalaxyXHeaderWalker.g:21:4: i1= FIXED_LITERAL
                    {
                    ...
                    break;
                case 4 :
                    // C:\\Users\\Timo\\EclipseProjects\\GalaxyX\\build\\classes\\com\\galaxyx\\galaxyxparser\\GalaxyXHeaderWalker.g:22:4: i1= CHARACTER_LITERAL
                    {
                    ...
                    break;
                case 5 :
                    // C:\\Users\\Timo\\EclipseProjects\\GalaxyX\\build\\classes\\com\\galaxyx\\galaxyxparser\\GalaxyXHeaderWalker.g:23:4: i1= STRING_LITERAL
                    {
